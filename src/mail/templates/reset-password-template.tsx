...
export function ResetPasswordTemplate({ url, name }: ResetPasswordProps) {
  return (
    <Html lang="pt-BR">
      <Head />
      <Tailwind
      ...
      >
        <Body>
          <Preview>Olá, {name}! Crie uma nova senha para sua conta.</Preview>
          <Container>
                  ...
                  <tr>
                    <td align="center" className="p-[40px] text-center">
                      ...
                      <Text className="m-0 mt-[20px] text-[16px] text-zinc-900 leading-[24px]">
                        Falta pouco para redefinir sua senha! Basta clicar no
                        botão abaixo para criar uma nova senha para sua conta.
                      </Text>
                      <Button
